...
public class RestContoller {
	...
	/*
	 * @GetMapping("testpage/datas/{location}") public RestModel
	 * findLocation(@PathVariable String location) { logger.info("location is = {}",
	 * location); return restserv.location(location);
	 */
		
	/* @GetMapping("departmentMap/datas/{location}") */
	
	@PostMapping("departmentMap/datas/{location}")
