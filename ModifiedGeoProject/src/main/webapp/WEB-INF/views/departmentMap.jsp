	...
	$("#star").click(function(){
		...
		$(document).ready(function() {
			  $("input[name='department']").click(function(event) {
			    ...
			    $.ajax({
			      type: "POST",
			      url: "departmentMap/datas/" + location,
		...
		/* $.ajax({
			type : "POST",
			url: "departmentMap/datas/" + location, // Include the location value in the URL
			data: { department: "your_department_value" }, // Replace "your_department_value" with the actual value
			dataType : "json",
			success : function(data){
				console.log("success data is = " + data);
				let print = $("#print");
